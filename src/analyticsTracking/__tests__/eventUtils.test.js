...
describe('analyticsTracking eventUtils', () => {
  ...
  describe('dropdownTracking', () => {
    ...
    describe('onOpen', () => {
      ...
      it(`should use a standard "${
      ...
      }__<normalized_name>__OPEN" eventType when no eventType params are given`, () => {
        const mockDropdown = dropdownTracking(mockLogger)(
        ...
        /** @TODO: use json schema to validate this  */
        expect(mockLogger).toHaveBeenCalledWith(
          `DROPDOWN__${normalizeEventType(mockDropdownEventParams.name)}__OPEN`,
          mockDropdownEventProps,
        );
      });
    ...
    describe('onClose', () => {
      ...
      it(`should use a standard "${
        EVENT_CONSTANTS.DROPDOWN.scope
      }__<normalized_name>__CLOSE" eventType when no eventType param is given`, () => {
        const mockDropdown = dropdownTracking(mockLogger)(
          ...Object.values(mockDropdownEventParams).slice(0, 2),
        );
    ...
    describe('onChange', () => {
      ...
      it(`should use a standard "${
        EVENT_CONSTANTS.DROPDOWN.scope
      }__<normalized_name>__CHANGE" eventType when no eventType param is given`, () => {
        const mockDropdown = dropdownTracking(mockLogger)(
          ...Object.values(mockDropdownEventParams).slice(0, 2),
        );
