...
import {
  STUDY_TABLE__TOOLTIP_PROJECTS__EVENT,
  STUDY_TABLE__TOOLTIP_FILES__EVENT,
  STUDY_TABLE__TOOLTIP_INFO__EVENT,
  STUDY_TABLE__CLICK,
} from './STUDY_TABLE';

import {
  STUDY_CARD__TOGGLE_DETAIL,
  STUDY_CARD__TOOLTIP_FILES__EVENT,
  STUDY_CARD__TOOLTIP_INFO__CLICK,
  STUDY_CARD__TOOLTIP_PROJECTS__EVENT,
} from './STUDY_CARD';
...
const schemas = {
  ...
  // study table view
  STUDY_TABLE__CLICK: STUDY_TABLE__CLICK,
  STUDY_TABLE__TOOLTIP_INFO__CLICK: {
    ...STUDY_TABLE__TOOLTIP_INFO__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_INFO__CLICK',
  },
  STUDY_TABLE__TOOLTIP_INFO__HOVER: {
    ...STUDY_TABLE__TOOLTIP_INFO__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_INFO__HOVER',
  },
  STUDY_TABLE__TOOLTIP_PROJECTS__CLICK: {
    ...STUDY_TABLE__TOOLTIP_PROJECTS__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_PROJECTS__CLICK',
  },
  STUDY_TABLE__TOOLTIP_PROJECTS__HOVER: {
    ...STUDY_TABLE__TOOLTIP_PROJECTS__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_PROJECTS__HOVER',
  },
  STUDY_TABLE__TOOLTIP_FILES__HOVER: {
    ...STUDY_TABLE__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_FILES__HOVER',
  },
  STUDY_TABLE__TOOLTIP_FILES__CLICK: {
    ...STUDY_TABLE__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_FILES__CLICK',
  },
  STUDY_TABLE__TOOLTIP_PENDING_REVIEW__HOVER: {
    ...STUDY_TABLE__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_PENDING_REVIEW__HOVER',
  },
  STUDY_TABLE__TOOLTIP_CHANGES_NEEDED__HOVER: {
    ...STUDY_TABLE__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_CHANGES_NEEDED__HOVER',
  },
  STUDY_TABLE__TOOLTIP_APPROVED__HOVER: {
    ...STUDY_TABLE__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_APPROVED__HOVER',
  },
  STUDY_TABLE__TOOLTIP_PROCESSED__HOVER: {
    ...STUDY_TABLE__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_TABLE__TOOLTIP_PROCESSED__HOVER',
  },
  // study card
  STUDY_CARD__TOGGLE_DETAIL: STUDY_CARD__TOGGLE_DETAIL,
  STUDY_CARD__TOOLTIP_FILES__CLICK: {
    ...STUDY_CARD__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_FILES__CLICK',
  },
  STUDY_CARD__TOOLTIP_FILES__HOVER: {
    ...STUDY_CARD__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_FILES__HOVER',
  },
  STUDY_CARD__TOOLTIP_PENDING_REVIEW__HOVER: {
    ...STUDY_CARD__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_PENDING_REVIEW__HOVER',
  },
  STUDY_CARD__TOOLTIP_CHANGES_NEEDED__HOVER: {
    ...STUDY_CARD__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_CHANGES_NEEDED__HOVER',
  },
  STUDY_CARD__TOOLTIP_APPROVED__HOVER: {
    ...STUDY_CARD__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_APPROVED__HOVER',
  },
  STUDY_CARD__TOOLTIP_PROCESSED__HOVER: {
    ...STUDY_CARD__TOOLTIP_FILES__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_PROCESSED__HOVER',
  },
  STUDY_CARD__TOOLTIP_INFO__CLICK: STUDY_CARD__TOOLTIP_INFO__CLICK,
  STUDY_CARD__TOOLTIP_INFO__HOVER: {
    ...STUDY_CARD__TOOLTIP_INFO__CLICK,
    $id: 'STUDY_CARD__TOOLTIP_INFO__HOVER',
  },
  STUDY_CARD__TOOLTIP_PROJECTS__CLICK: {
    ...STUDY_CARD__TOOLTIP_PROJECTS__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_PROJECTS__CLICK',
  },
  STUDY_CARD__TOOLTIP_PROJECTS__HOVER: {
    ...STUDY_CARD__TOOLTIP_PROJECTS__EVENT,
    $id: 'STUDY_CARD__TOOLTIP_PROJECTS__HOVER',
  },
  // study docs list
