...
import {
  CAVATICA_PROJECTS__CLICK,
  CAVATICA_PROJECTS__HOVER,
  TOOLTIP__FILES__CLICK,
  TOOLTIP__file_status__HOVER,
} from './STUDY_TABLE';
...
const schemas = {
  ...
  // study table view
  CAVATICA_PROJECTS__CLICK: CAVATICA_PROJECTS__CLICK,
  CAVATICA_PROJECTS__HOVER: CAVATICA_PROJECTS__HOVER,
  TOOLTIP__FILES__CLICK: TOOLTIP__FILES__CLICK,
  TOOLTIP__file_status__HOVER: TOOLTIP__file_status__HOVER,
  // study card
