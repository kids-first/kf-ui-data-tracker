  ...
  <>
    <Grid.Row>
      <Grid.Column width={4}>
        ...
        <p>
          Templated types reflect the data templates your organization has setup
          for your studies. They follow a defined file structure and can help
          the DRC process the file faster.
        </p>
        <Header size="small">General Types</Header>
        <p>
          Use a General type if none of the Templated types provide the
          appropriate categorization for your file. General types are still used
          by the DRC to help organize and find files.
        </p>
      </Grid.Column>
